...
import { getSourceFrame } from "../store/sources";
import { areaSelected,areaRename,areaDelete } from "../store/areas";
...
function AddAiTask() {
    ...
    const [showAppSetting, setShowAppSetting] = useState(true);
    ...
    const areaLineArr = useSelector((state) => state.areas.areaLineArr);
    ...
    const handleSubmit = () => {
        ...
        areaNameArr.forEach(function (value, idx, array) {
            ...
            if (selectedApplication.toLowerCase()==='movement_zone'){
                log('add line info')
                log(areaLineArr[idx])
                myLine[lineNameArr[idx][0]]=[[convertToScale(areaLineArr[idx][0][0],drawWidth),convertToScale(areaLineArr[idx][0][1],drawHeight)],[convertToScale(areaLineArr[idx][0][2],drawWidth),convertToScale(areaLineArr[idx][0][3],drawHeight)]];
                myLine[lineNameArr[idx][1]]=[[convertToScale(areaLineArr[idx][1][0],drawWidth),convertToScale(areaLineArr[idx][1][1],drawHeight)],[convertToScale(areaLineArr[idx][1][2],drawWidth),convertToScale(areaLineArr[idx][1][3],drawHeight)]];
            }
                    ...
                    <div className="row mb-2 p-2">
                        ...
                        <div className="col-12 d-flex justify-content-start align-items-center my-flex-gap gap-3 py-3">
                            <div>
                                ...
                                <div>
                                    <CustomInput defaultValue="" width="240" height="52" ref={taskNameRef} onChange={()=>{}}></CustomInput>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div>
                                    <CustomSelect areaArr={modelArr} width="240" height="52" fontSize="16" className="my-dropdown-select" onChange={handleModelChange} placeHolder={true} ref={modelRef} ></CustomSelect>
                                </div>
                            </div>
                            <div>
                                <div className='my-input-title roboto-b2 py-1'>
                                ...
                                <div>
                                    <CustomSelect areaArr={applicationOptions} width="240" height="52" fontSize="16" className="my-dropdown-select" onChange={handleApplicationChange} placeHolder={true}></CustomSelect>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 d-flex justify-content-start align-items-center my-flex-gap gap-3">
                            <div>
                                ...
                                <div>
                                    <CustomInput defaultValue="0.9" width="240" height="52" ref={confidenceRef} onChange={()=>{}}></CustomInput>
                                </div>
                            </div>
                            <div>
                                <div className='my-input-title roboto-b2 py-1'>
