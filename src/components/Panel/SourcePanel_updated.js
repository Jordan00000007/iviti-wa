...
const SourcePanel = forwardRef((props, ref) => {
    ...
    const rtspRef = useRef(null);
    const v4l2Ref = useRef(null);
    ...
    //     //     //v4l2Ref.current.click();
    //     // }
    //     // if (type==='RTSP'){
    //     //     cameraRef.current.click();
    //     //     //rtspRef.current.click();
    //     // }
                            ...
                            }
                            {
                                ...
                                <div className="row ">
                                    <div className="col-12 d-flex justify-content-between">
                                        <CustomSelect areaArr={v4l2Options} width="395" height="32" fontSize="16" placeHolder={true} onChange={handleV4l2Selected}></CustomSelect>
                                    </div>
                                </div>
