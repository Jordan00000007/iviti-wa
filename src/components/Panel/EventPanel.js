        ...
        <div className='my-area-p3-c5'>
           <div className="row ">
                <div className="col-12 d-flex justify-content-between align-items-center mt-2">
                    ...
                    <div>
                        <EventToggle status='run' onChange={handleToggleChange} ref={_eventPanelEnableRef}></EventToggle>
                    </div>
                </div>
                ...
                <div className="col-12 d-flex justify-content-between mt-2">
                    <div className='d-flex flex-column'>
                        ...
                        <CustomSelectLogic areaArr={[['>','>'],['=','='],['<','<']]} onChange={handleLogicChange} width="130" height="36" ref={_eventPanelLogicRef}></CustomSelectLogic>
                    </div>
                    <div className='d-flex flex-column'>
