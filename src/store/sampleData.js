const data=[
    {
      "tag": "obj", 
      "framework": "openvino", 
      "name": "雅虎是一家美國網際網路服務提供商，品牌旗下知名服務有入口網站、電子信箱、體育以及新聞等服務。", 
      "uuid": "1c6cdf06", 
      "status": "stop", 
      "error": "", 
      "model": "雅虎是一家美國網際網路服務提供商.xml", 
      "application": {
        "name": "雅虎是一家美國網際網路服務提供商", 
        "depend_on": [
          "person"
        ], 
        "area_points": {}, 
    ...
    }, 
    {
      "tag": "obj", 
      "framework": "openvino", 
      "name": "object-detection-sample", 
      "uuid": "7b7af015", 
      "status": "stop", 
      "error": "", 
      "model": "yolo-v3-tf.xml", 
      "application": {
        "name": "default", 
        "depend_on": [
          "person", 
    ...
    }, 
    {
      "tag": "obj", 
      "framework": "openvino", 
      "name": "parking-lot-detect", 
      "uuid": "cb42c0b5", 
      "status": "run", 
      "error": "", 
      "model": "yolo-v4-tiny-tf.xml", 
      "application": {
        "name": "area_detection", 
        "depend_on": [
          "car"
    ...
    }, 
    {
      "tag": "obj", 
      "framework": "openvino", 
      "name": "traffic-flow-detect", 
      "uuid": "a8f2f690", 
      "status": "stop", 
      "error": "", 
      "model": "yolo-v4-tiny-tf.xml", 
      "application": {
        "name": "trackingtrackingtrackingtrackingtrackingtrackingtrackingtrackingtrackingtrackingtracking", 
        "depend_on": [
          "car"
        ], 
        "area_points": {
